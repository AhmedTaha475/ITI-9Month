...
{
    int i,j;
    char** MLines=  new char*[c]; ///allocate the array of strings inside the heap with c++ syntax
...
void display( int Id)
{
    ...
    if(Pdis==NULL)
        ...
        //printf("%d \n",Pdis->Data.ID);
        //cout<<Pdis->Data.ID<<endl;
        cout<<"ID: "<<Pdis->Data.ID<<" "<<"Name:"<<Pdis->Data.Name<<" "<<"Age:"<<Pdis->Data.Age<<" "<<"Gender:"<<Pdis->Data.Gender<<" "<<"Address:"<<Pdis->Data.Address<<" "<<"NetSalary:"<<NetSalary(Pdis->Data.Salary,Pdis->Data.Deduct,Pdis->Data.overTime)<<endl;
}
...
//printf("\nID:%i Name:%s Age:%i Gender:%c Address:%s  NetSalary:%lf\n",Pda->Data.ID,Pda->Data.Name,Pda->Data.Age,Pda->Data.Gender,Pda->Data.Address,NetSalary(Pda->Data.Salary,Pda->Data.Deduct,Pda->Data.overTime));
        cout<<"ID: "<<Pda->Data.ID<<" "<<"Name: "<<Pda->Data.Name<<" "<<"Age: "<<Pda->Data.Age<<" "<<"Gender: "<<Pda->Data.Gender<<" "<<"Address: "<<Pda->Data.Address<<" "<<"NetSalary: "<<NetSalary(Pda->Data.Salary,Pda->Data.Deduct,Pda->Data.overTime)<<endl;
        Pda=Pda->Pnext;
    }
}
        ...
        case Enter:
            ...
            case 0:///New
                ...
                if(SP !=NULL)
                {
                    ...
                    cout<<"This Index Already Has Data Do you Want to overwrite it y/n  ?";
                    test=getchar();
                }
            ...
            case 3:                    //Delete By ID
                ...
                if(SP!=NULL)
                {
                    ...
                    cout<<"Data Row has been deleted by ID";
                }
                ...
                if(counter1==0)
                {
                    ...
                    cout<<"There is no data with that ID";
                }
                _getch();
                break;
            case 4: // Delete ALL
                ...
                cout<<"All rows have been deleted";
                counter=1;
